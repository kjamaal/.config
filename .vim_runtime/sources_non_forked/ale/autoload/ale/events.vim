    ...
    augroup ALEEvents
        ...
        if g:ale_enabled
            ...
            if g:ale_echo_cursor || g:ale_cursor_detail
                autocmd CursorMoved,CursorHold * silent! if exists('*ale#engine#Cleanup') | call ale#cursor#EchoCursorWarningWithDelay() | endif
            ...
            if g:ale_virtualtext_cursor
                autocmd CursorMoved,CursorHold * silent! if exists('*ale#engine#Cleanup') | call ale#virtualtext#ShowCursorWarningWithDelay() | endif
                " Look for a warning to echo as soon as we leave Insert mode.
                " The script's position variable used when moving the cursor will
                " not be changed here.
            ...
            if g:ale_hover_cursor
                autocmd CursorHold * silent! if exists('*ale#lsp#Send') | call ale#hover#ShowTruncatedMessageAtCursor() | endif
            endif
